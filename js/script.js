...
function ativarLink(link) {
  ...
  if (url.includes(href)) {
    //includes verifica se te tem a mesma palavra no texto link
...
function ativarPergunta(event) {
  //CRIOU UMA FUNÇÃO COM O EVENTO DENTRO, POIS ESSA FUNÇÃO TERA UM EVENTO DE CLIQUE
...
function eventosPerguntas(pergunta) {
  //CRIOU UMA FUNÇÃO PARA CHAMAR O LAÇO DE REPETIÇÃO
